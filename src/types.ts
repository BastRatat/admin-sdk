...
export type MicroserviceAuthConfig = {
  readonly supabaseUrl: string; // Supabase project URL
  readonly supabaseServiceKey: string; // Service role key (server-side only)
...
/**
 * Legacy AuthConfig for backward compatibility
 * @deprecated Use MicroserviceAuthConfig instead
 */
